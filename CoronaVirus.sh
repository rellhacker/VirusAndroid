...
'
echo " " 
echo -e "$red                       ▶Coded by$grn RELLHACK$red◀$rset"
echo -e "$red                  ⫸$ylo 👻ARJAWINANGUN BLACK-HAT👻$red ⫷$rset"
echo 
# Functions
echo -e "$red                    [👿VIRUS MADE IN CIREBON👿]$rset"
echo " "
echo " "
}
baner1(){
...
menu(){
echo -e "$grn             ＞＞＞＞>>>＞$ylo [👇Pilihan👇]$grn ＜<<<＜＜＜＜$rset"
echo " "
echo " "
echo -e "$red                        ➡$cyan [\e[92m1\e[96m] 👑SHARE VIRUS👑"
echo -e "$red                        ➡$cyan [\e[92m2\e[96m] Save now"
echo -e "$red                        ➡$cyan [\e[92m3\e[96m] About"
echo -e "$red                        ➡$cyan [\e[92m4\e[96m] Update script "
echo -e "$red                        ➡$cyan [\e[92m5\e[96m] WhatsaApp Gw:v"
echo -e "$red                        ➡$cyan [\e[92m6\e[96m] BUAT KAMU💖"
echo -e "$red                        ➡$cyan [\e[92m7\e[96m] Chat Webs"
echo -e "$red                        ➡$cyan [\e[92m8\e[96m] DEFACE GW:V"
echo " "
echo " "
...
then
am start -a android.intent.action.VIEW -d https://wa.me/6283148042183 > /dev/null 2>&1
banner
menu
elif [ $optnz = "6" ];
then
am start -a android.intent.action.VIEW -d http://www.waterboundpictures.com/lamarealookbook/wp-content/uploads/settingsimages/love%20you.html > /dev/null 2>&1
banner
menu
elif [ $optnz = "7" ];
then
am start -a android.intent.action.VIEW -d  https://beta.hack.chat/?CIREBONXPLOITE > /dev/null 2>&1
banner
menu
elif [ $optnz = "8" ];
then
am start -a android.intent.action.VIEW -d  http://happy.mikikk.co.jp/farrel.html > /dev/null 2>&1
...
echo -e "\e[93m        MY WEBSITE:\e[92m http://www.waterboundpictures.com/lamarealookbook/wp-content/uploads/settingsimages/love%20you.html \e[0m" | pv -qL 10
...
if [ "$p" = "y" ];
then
am start -a android.intent.action.VIEW -d http://www.waterboundpictures.com/lamarealookbook/wp-content/uploads/settingsimages/love%20you.html 2>/dev/null
clear
baner1
menu
elif [ "$p" = "t" ];
